...
describe("DELETE /api/comments/id", () => {
  test("return 204 when delete successful ", () => {
    return request(app)
      .delete("/api/comments/1")
      .expect(204)

  });
  test("return 404 if comment cant be found", () => {
    return request(app)
      ...
      .then(({
        ...
        expect(body.msg).toBe("Comment cant be found");
      });
  });
  test("return 400 if wrong datatype", () => {
    return request(app)
